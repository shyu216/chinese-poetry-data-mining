"""
script: 04_word_sim_v3.py
stage: P3-向量模型
artifact: FlatBuffers 相似词索引
purpose: 将 v2 相似词数据转换为 FlatBuffers 二进制并生成词表。
inputs:
- results/word_similarity_v2
- flatbuffers/WordSimilarity.fbs
outputs:
- results/word_similarity_v3
- scripts/flatbuffers_generated/WordSimilarity
depends_on:
- word_sim_v2.py
