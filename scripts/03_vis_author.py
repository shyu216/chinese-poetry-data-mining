...
def load_author_sentiment_data(project_root: Path) -> dict:
    """加载诗人情感分析结果"""
    result_path = project_root / "reports" / "sentiment_analysis" / "author_sentiment.json"
...
def main():
    ...
    # 加载分析结果
    print("\n加载分析结果...")
    data = load_author_sentiment_data(project_root)
