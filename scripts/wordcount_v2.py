...
数据格式:
- 每个chunk: JSON数组 [[word, count, rank], ...]  // 紧凑格式，减少key重复
- meta.json: {chunks: [{file, start_rank, end_rank, count, start_word, end_word}]}

Chunk策略:
- 高频词(前10000): 单独chunk，每chunk 1000词
- 中频词(10001-100000): 每chunk 10000词  
- 低频词(100001+): 每chunk 50000词
- 文件名: chunk_0000.json, chunk_0001.json ... (顺序编号)

输出:
- results/wordcount_v2/chunk_*.json
- results/wordcount_v2/meta.json
"""
