...
输出文件:
- author_clusters/clusters_metadata.json (聚类元数据)
- author_clusters/clusters_data.json (诗人坐标和聚类信息)
- author_clusters/cluster_features.json (每个流派的特征)

命令行:
python scripts/author_clustering_v3.py
"""
