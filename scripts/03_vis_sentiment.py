...
def load_sentiment_data(project_root: Path, data_type: str = 'sample') -> dict:
    """加载情感分析结果"""
    result_path = project_root / "reports" / data_type / "sentiment_analysis" / "sentiment_distribution.json"
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='情感可视化')
    ...
    # 加载分析结果
    print("\n加载分析结果...")
    data = load_sentiment_data(project_root, args.data)
